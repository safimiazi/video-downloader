      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {platforms.map((platform) => (
            ...
            >
              <div
                className={`bg-gradient-to-br ${platform.bgColor} ${platform.darkBgColor} rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 p-6 border border-gray-200 dark:border-gray-700 `}
              >
                <div className="text-5xl mb-4">{platform.icon}</div>

                <h2
                  className={`text-2xl font-bold bg-gradient-to-r ${platform.color} bg-clip-text text-transparent mb-2`}
                >
                  {platform.name}
                </h2>
        ...
        <footer className="mt-12 text-center text-gray-500 dark:text-gray-400 text-sm">
          <p>
            © 2026 Video Downloader. Please respect copyright and terms of
            service.
          </p>
        </footer>
      </div>
